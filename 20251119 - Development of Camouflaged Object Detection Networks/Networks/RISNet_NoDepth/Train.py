...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_path', type=str, default='./Datasets/Sampled_COD10K/Train', help='path to train dataset')
    ...
    train_image_root = '{}/Image/'.format(opt.train_path)
    train_gt_root = '{}/GT_Object/'.format(opt.train_path)
    train_loader = get_loader(train_image_root, train_gt_root, batch_size=opt.batchsize, image_size=opt.trainsize, num_workers=1)
